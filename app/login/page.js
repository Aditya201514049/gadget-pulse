      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl overflow-hidden z-10">
        ...
        <div className="p-8">
          ...
          <div className="flex justify-center space-x-6 text-sm">
            <a href="#" className="text-blue-500 hover:text-blue-700 font-medium transition-colors">Support</a>
            <span className="text-gray-300">|</span>
            <a href="#" className="text-blue-500 hover:text-blue-700 font-medium transition-colors">About</a>
            <span className="text-gray-300">|</span>
            <a href="#" className="text-blue-500 hover:text-blue-700 font-medium transition-colors">Theme</a>
          </div>
        </div>
      </div>
